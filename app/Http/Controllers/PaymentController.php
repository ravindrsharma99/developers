...
class PaymentController extends BaseController
{
    ...
    public function getCard(){
        $user = auth()->user();
        $btPaymentMethod = BtPaymentMethod::where('user_id' , 3)->first();
        if(!$btPaymentMethod){
            return [
                'status' => false,
...
//             'paymentMethodToken' => 'vuyjlBjTHH8MDGuT',
//             'options' => [
...
// if(isset($app->paypal_id))
// {    
//  $paypal_id=$app->paypal_id;            
// }else
// {
//  $paypal_id="";
// }
...
// {    
     $receivers = array(
          0 => array(
            ...
            'Amount'        => round("0.5",2),
            'UniqueId'      => uniqid(), 
            'Note'          => "12 App Purchased")
        );
// }        

$MassPay = PaypalMassPayment::executeMassPay('App Purchased', $receivers);
echo "<pre>";
print_r($MassPay);die;
// if($MassPay['ACK']=="Success")
// {

//   $result = DeveloperPayments::create([
//                 'app_id' => $app->id,
//                 'amount' => round($developerAmount,2),
//                 'user_id' => 3,//$user->id,
//                 'status' => "success",
//                 'owner_id' =>$app->userid,
//                 'paypal_id' =>$paypal_id,
//                 'transaction_id' => $MassPay['CORRELATIONID'],
