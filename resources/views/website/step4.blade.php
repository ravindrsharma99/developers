                            ...
                            <div id="tab-1" class="tab-panel active">
                                ...
                                <section class="ai06-cart-step">
                                    <ul>
                                        ...
                                        <li class="active"><a href="{{url('step4')}}"><span class="cp-img-04">APP CONFIRMED</span></a></li>
                                        <div class="clearfix"></div>
                                    </ul>
                                </section><!--ai06-cart-step-->

                                <div class="col-md-6">
                                    <form class="login" method="post" action="{{url('step4_update')}}" enctype="multipart/form-data">
