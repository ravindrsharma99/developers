...
<main class="site-main">
    <div class="container-inner">
        <div class="tab-shopping">
            <div class="tab-shoppping-cart"> @include('website.sidemenu')
                        ...
                        <div class="box-content">
                            <div class="toolbar-products"> 
                                ...
                                <div class="alert alert-warning alert-dismissible" role="alert">
                                    ...
                                    </button> {{ \Illuminate\Support\Facades\Session::get('success') }} 
                                </div> 
                                @endif 
                                ...
                                <div class="alert alert-danger alert-dismissible" role="alert">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button> {{ \Illuminate\Support\Facades\Session::get('danger') }} </div> 
                                @endif
                                <div class="toolbar-option toolbar-option-top" style="border-bottom: none;">
                                    <h4 class="title-primary">My Submitted Apps</h4>
                                    @if(count($submitted_app)>0)
                                    <div class="products auto-clear"> 
                                    @foreach($submitted_app as $list)
                                        <div class="product-item style-3">
                                            <div class="product-inner">
                                                <div class="product-thumb"> 
                                                    @if($list['apk_icon'] !="" && file_exists($list['apk_icon']))
                                                    <div class="thumb-inner s" style="background-image: url({{$list['apk_icon'] }});background-size: contain;background-repeat: no-repeat;background-position: center;">
                                                    </div> 
                                                    @endif
                                                    <a href="{{url('app_detail/'.$list->id)}}" class="quick-view">
                                                ...
                                                <div class="product-innfo">
                                                    ...
                                                    @include('components.rating', ['rating' => $list->average_rating])
                                                    
                                                    <div class="hover-hidden">
                                                        <p class="product-des">{{substr($list['description'],0,280)}} @if(strlen($list['description'])
                                                            > 280 ) ... @endif</p>
                                                        <div class="post-metas">
                                                            <span class="icon icon-time">
                                                                <img src="{{ URL::asset('assets/website/images/blog/icon-calender.jpg') }}" alt="icon">
                                    ...
                                    <div class="toolbar-products" style="border-bottom: none;">
                                        <div class="toolbar-option toolbar-option-bottom">
                                            <div class="pagination pagination-bottom">
                                                <ul class="nav-links">
                                                    <li> @include('website.pagination.limit_links', ['paginator' => $submitted_app])</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div> 
