                        ...
                        <div class="tab-container" style="padding-top: 0px;">
                            ...
                            <div id="tab-1" class="tab-panel active">
                                ...
                                <section class="ai06-cart-step">
                                    ...
                                    <div class="">
                                        ...
                                        <ul>
                                            ...
                                            <li class="active"><a href="{{url('step1/'.$step1_app->id)}}"><span class="cp-img-04">UPLOAD APK FILE</span></a></li>

                                            <li class="active"><a href="{{url('step2/'.$step1_app->id)}}"><span class="cp-img-04">APP DETAILS</span></a></li>

                                            <li class="active"><a href="{{url('step3/'.$step1_app->id)}}"><span class="cp-img-04">APP SCREENSHOTS</span></a></li>

                                            <li class="active"><a href="{{url('step4/'.$step1_app->id)}}"><span class="cp-img-04">APP CONFIRMED</span></a></li>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <form class="step1" method="post" action="{{url('step1/'.$step1_app->id)}}" enctype="multipart/form-data">
                                        ...
                                        <p class="form-row form-row-wide">
                                            ...
                                            {!! Form::text('app_name', $step1_app->app_name, ['class' => 'input-text']) !!}
                                       ...
                                       <p class="form-row form-row-wide">
                                        ...
                                        <div class="fileUpload btn btn-warning">
                                            ...
                                            if (!empty($step1_app->apk_icon) && $step1_app->apk_icon != "" && file_exists($step1_app->apk_icon)) {

                                            ?>

                                            <br><img id="DisplayImage" src="{{ url($step1_app->apk_icon) }}" name="img" id="img" width="150" style="padding-bottom:5px" >
