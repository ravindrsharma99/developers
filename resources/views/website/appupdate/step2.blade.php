                        ...
                        <div class="tab-container" style="padding-top: 0px;">
                            <div id="tab-1" class="tab-panel active">
                                <section class="ai06-cart-step">
                                    ...
                                    <ul>
                                        <li class="active"><a href="{{url('step1/'.$step2_app->id)}}"><span class="cp-img-04">UPLOAD APK FILE</span></a></li>
                                        <li class="active"><a href="{{url('step2/'.$step2_app->id)}}"><span class="cp-img-04">APP DETAILS</span></a></li>

                                        @if($step2_app['step'] == '2' || $step2_app['step'] == '3' || $step2_app['step'] == '4')
                                          <li class="active"><a href="{{url('step3/'.$step2_app->id)}}"><span class="cp-img-04">APP SCREENSHOTS</span></a></li>
                                        @else
                                            <li class="active"><a href="javascript:;"><span class="cp-img-04">APP SCREENSHOTS</span></a></li>
                                        @endif

                                        @if($step2_app['step'] == '3' || $step2_app['step'] == '4')
                                            <li class="active"><a href="{{url('step4/'.$step2_app->id)}}"><span class="cp-img-04">APP CONFIRMED</span></a></li>
                                        @else
                                ...
                                <div class="col-md-6">
                                    <form class="step2" method="post" action="{{url('step2/'.$step2_app->id)}}" enctype="multipart/form-data">

                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">

                                        <p class="form-row form-row-wide">
                                            <label for="version_number">Version Name <span class="note-impor">*</span></label>
                                            {!! Form::text('version_number', $step2_app['version_number'], ['class' => 'input-text']) !!}
                                        ...
                                        <p class="form-row form-row-wide">
                                            ...
                                            {!! Form::text('version_code', $step2_app['version_code'], ['class' => 'input-text important-input']) !!}
                                        ...
                                        <p class="form-row form-row-wide">
                                            ...
                                            {!! Form::text('package_id', $step2_app['package_id'], ['class' => 'input-text important-input']) !!}
                                        ...
                                        <p class="form-row form-row-wide">
                                            ...
                                            {!! Form::select('category', [''=>'Please select'] + $category_id, $step2_app->category,['class' => 'select-detail']) !!}
                                        ...
                                        <p class="form-row form-row-wide">
                                            ...
                                            {!! Form::select('price', \App\NewApp::$price, $step2_app['price'],['id' => 'price-select', 'class' => 'select-detail','onchange'=>'show_price(this.value)']) !!}
                                            @if ($errors->has('price'))
                                                <span class="help-block" style="color: red">
                                        ...
                                        <!-- price amount -->
                                        <p class="form-row form-row-wide @if($step2_app['price']=='Price') @else hide-input  @endif" id="price_div">
                                            <label for="amount">Amount in USD <span class="note-impor">*</span></label>
                                            {!! Form::select('amount', \App\NewApp::$amount, !empty($step2_app['amount'])? $step2_app['amount']: null, ['class' => 'select-detail']) !!}
                                        ...
                                        <!-- paypal account -->
                                        <p class="form-row form-row-wide @if($step2_app['price']=='Price')  @else hide-input  @endif" id="price_div1">
                                            ...
                                            {!! Form::email('paypal_id', $step2_app['paypal_id'], ['class' => 'input-text']) !!}
                                        ...
                                        <p class="form-row form-row-wide">
                                            ...
                                            {!! Form::text('support_email', $step2_app['support_email'], ['class' => 'input-text']) !!}
                                        ...
                                        <p class="form-row form-row-wide">
                                            ...
                                            {!! Form::text('company', $step2_app['company'], ['class' => 'input-text']) !!}
                                        ...
                                        <p class="form-row form-row-wide">
                                            ...
                                            {!! Form::text('contact_email', $step2_app['contact_email'], ['class' => 'input-text']) !!}
                                        ...
                                        <p class="form-row form-row-wide">
                                            ...
                                            {!! Form::textarea('description', $step2_app['description'], ['class' => 'textarea-control','rows'=>'5','cols'=>'35']) !!}
