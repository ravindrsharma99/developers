                            ...
                            <div id="tab-1" class="tab-panel active">
                                <section class="ai06-cart-step">
                                    <ul>
                                        ...
                                        <li class="active"><a href="{{url('step3')}}"><span class="cp-img-04">APP SCREENSHOTS</span></a></li>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <form class="step3" id="step3" method="post" action="{{url('step3_update')}}" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="app_id" value="{{$newapp->id}}">
            ...
            if(total_file == 1) {
                ...
                jQuery.ajax({
                    ...
                    success: function (data) {
                        var hiid = document.getElementById('hiddid').value;
                        $("#ss"+hiid).attr("href", 'step3/'+data+'/destroy');
